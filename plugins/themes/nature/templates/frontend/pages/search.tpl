...
<div class="page page_search">
    ...
    <form class="cmp_form" method="get" action="{$smarty.capture.searchFormUrl|strtok:"?"|escape}">
        ...
        <fieldset class="search_advanced">
            ...
            <div class="date_range">
                <div class="from">
                    ...
                    {html_select_date_a11y legend=$dateFromLegend prefix="dateFrom" time=$dateFrom start_year=$yearStart
                    end_year=$yearEnd}
                </div>
                <div class="to">
                    {capture assign="dateFromTo"}{translate key="search.dateTo"}{/capture}
                    {html_select_date_a11y legend=$dateFromTo prefix="dateTo" time=$dateTo start_year=$yearStart
                    end_year=$yearEnd}
                </div>
            </div>
            <div class="author">
        ...
        <div class="submit">
            <button class="submit bg-[#00504F]" type="submit">{translate key="common.search"}</button>
        </div>
    </form>
    ...
    <ul class="search_results">
        ...
        <li>
            ...
            journal=$result.journal showDatePublished=true hideGalleys=true heading="h3"}
        </li>
        {/iterate}
    </ul>
    ...
    <div class="cmp_pagination">
        ...
        {page_links anchor="results" iterator=$results name="search" query=$query searchJournal=$searchJournal
        authors=$authors dateFromMonth=$dateFromMonth dateFromDay=$dateFromDay dateFromYear=$dateFromYear
