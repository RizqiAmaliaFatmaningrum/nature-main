...
//         	edited by openjournaltheme.com 12 Jan 2021
            $articles[$submissionId]['author']        = $article->getAuthorString();
			$articles[$submissionId]['datePublished']        = $article->getDatePublished();
		}
