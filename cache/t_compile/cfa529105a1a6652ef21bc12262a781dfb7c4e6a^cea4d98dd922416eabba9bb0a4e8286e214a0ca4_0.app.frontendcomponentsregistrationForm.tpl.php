<?php
/* Smarty version 4.3.1, created on 2023-12-23 03:42:29
  from 'app:frontendcomponentsregistrationForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_65864915cf3bf9_43448327',
...
function content_65864915cf3bf9_43448327 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\openjournal\\lib\\pkp\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\function.html_options.php','function'=>'smarty_function_html_options',),));
?>
	...
	<div class="fields">
		<div class="form-group given_name">
			<label>
				...
				<input class="form-control rounded-2xl w-64 h-6 m-2" type="text" name="givenName" id="givenName" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['givenName']->value ));?>
" maxlength="255" required>
		...
		<div class="form-group family_name">
			<label>
				...
				<input class="form-control rounded-2xl w-64 h-6 m-2" type="text" name="familyName" id="familyName" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['familyName']->value ));?>
" maxlength="255" required>
			</label>
		</div>
		<div class="form-group affiliation">
			<label>
				...
				<input class="form-control rounded-2xl w-64 h-6 m-2" type="text" name="affiliation[<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['primaryLocale']->value ));?>
	...
	<div class="fields">
		<div class="form-group email">
			<label>
				...
				<input class="form-control rounded-2xl w-64 h-6 m-2" type="text" name="email" id="email" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['email']->value ));?>
" maxlength="90" required>
		...
		<div class="form-group username">
			<label>
				...
				<input class="form-control rounded-2xl w-64 h-6 m-2" type="text" name="username" id="username" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['username']->value ));?>
