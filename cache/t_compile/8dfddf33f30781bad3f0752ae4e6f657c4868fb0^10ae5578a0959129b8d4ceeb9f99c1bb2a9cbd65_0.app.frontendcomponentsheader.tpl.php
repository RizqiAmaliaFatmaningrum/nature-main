<?php
/* Smarty version 4.3.1, created on 2023-12-13 09:38:33
  from 'app:frontendcomponentsheader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_65796d892ab496_80684909',
...
function content_65796d892ab496_80684909 (Smarty_Internal_Template $_smarty_tpl) {
...
">
	...
	<div class="pkp_structure_page">
			...
			<div class="container mx-auto">
								<nav class="p-5 bg-[#F4FEFD] shadow lg:flex items-center justify-between relative">
...
" class="is_text"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['displayPageHeaderTitle']->value ));?>
					...
					<?php $_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
					<nav id="nav-menu" class="hidden absolute px-5 py-5 bg-[#F4FEFD] shadow-lg max-w-[250px] w-full top-full right-0 lg:block lg:static lg:shadow-none p-5 bg-[#F4FEFD]">
					<?php if (!empty(trim($_smarty_tpl->tpl_vars['primaryMenu']->value)) || $_smarty_tpl->tpl_vars['currentContext']->value) {?>
						...
						<div class="lg:flex items-center font-bold">
