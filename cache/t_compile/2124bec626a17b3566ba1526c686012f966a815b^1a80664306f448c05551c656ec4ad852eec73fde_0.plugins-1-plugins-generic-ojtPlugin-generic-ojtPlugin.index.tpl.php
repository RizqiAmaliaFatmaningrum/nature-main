...
/* Smarty version 4.3.1, created on 2023-12-15 03:07:02
  from 'plugins-1-plugins-generic-ojtPlugin-generic-ojtPlugin:index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_657bb4c6163762_57645218',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1a80664306f448c05551c656ec4ad852eec73fde' => 
    array (
      0 => 'plugins-1-plugins-generic-ojtPlugin-generic-ojtPlugin:index.tpl',
      1 => 1701135468,
      2 => 'plugins-1-plugins-generic-ojtPlugin-generic-ojtPlugin',
    ),
  ),
  'includes' => 
  array (
...
function content_657bb4c6163762_57645218 (Smarty_Internal_Template $_smarty_tpl) {
if ($_smarty_tpl->tpl_vars['currentContext']->value) {?>
  <?php $_smarty_tpl->_assignInScope('logoImage', $_smarty_tpl->tpl_vars['currentContext']->value->getLocalizedData('pageHeaderLogoImage'));
}?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <link rel="shortcut icon" type="image/jpg" href="<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->favIcon;?>
" />
  <link rel="preconnect" href="https://fonts.gstatic.com">
  <link href="https://fonts.googleapis.com/css2?family=Allura&display=swap" rel="stylesheet">
  <link href="<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->tailwindCss;?>
" rel="stylesheet">
  <link href="<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->fontAwesomeCss;?>
" rel="stylesheet">
  <link href="<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->sweetAlertCss;?>
" rel="stylesheet">
  <style>
    [x-cloak] {
      display: none;
        ...
        <div class="ojt-flex ojt-flex-col ojt-h-full">
          <div class="ojt-py-6 ojt-flex">
            <a href="https://openjournaltheme.com/" target="_blank"
              ...
              aria-current="page">
              <img width="32" height="37" src="<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->logo;?>
" class="ojt-mx-auto">
          ...
          <div class="ojt-p-4 ojt-mx-auto ojt-w-full ojt-gap-2 ojt-flex ojt-flex-col ojt-border-t">
            ...
            <a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>(defined('ROUTE_PAGE') ? constant('ROUTE_PAGE') : null),'page'=>"ojt",'op'=>"support"),$_smarty_tpl ) );?>
" target="_blank"
              class="ojt-w-full ojt-text-sm ojt-flex ojt-text-gray-500 ojt-items-center ojt-px-4 ojt-py-2 ojt-rounded-xl ojt-from-primary-500 ojt-via-primary-600 ojt-to-primary-700 hover:ojt-bg-gradient-to-br hover:ojt-text-white ojt-gap-4 ojt-text-left">
            ...
            <a href="https://openjournaltheme.com/about-open-journal-theme" target="_blank"
              ...
              <img src="<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->logo;?>
" class="ojt-h-5">
              <span>ABOUT US</span>
            </a>
          </div>
          ...
          <div class="ojt-flex ojt-items-center ojt-justify-between ojt-p-2 ojt-border-b ">
            ...
            <div class="ojt-flex journal-header">
              <?php if ($_smarty_tpl->tpl_vars['displayPageHeaderLogo']->value) {?>
                <a href="<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->baseUrl;?>
" target="_blank" rel="home" aria-current="home">
                  <img src="<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->journalPublicFolder;
echo $_smarty_tpl->tpl_vars['logoImage']->value['uploadName'];?>
" class="ojt-max-h-16">
                </a>
              <?php } else { ?>
                <a href="<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->baseUrl;?>
" target="_blank" class="is_text"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['displayPageHeaderTitle']->value ));?>
</a>
              <?php }?>
            </div>
            <nav aria-label="Secondary" class="ojt-hidden ojt-space-x-2 md:ojt-flex md:ojt-items-center">
              <a class="ojt-flex ojt-items-center ojt-gap-2 ojt-text-primary-700 hover:ojt-text-white ojt-text-black hover:ojt-bg-primary-700 focus:ojt-ring-4 focus:ojt-outline-none focus:ojt-ring-primary-300 ojt-font-medium ojt-rounded-lg ojt-text-xs ojt-px-4 ojt-py-2 ojt-text-center"
                href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('journal'=>$_smarty_tpl->tpl_vars['journal']->value->getData('urlPath'),'page'=>"submissions"),$_smarty_tpl ) );?>
">
                ...
                <div class="ojt-flex ojt-items-center">
                  <div class="ojt-flex ojt-flex-col ojt-ml-3">
                    ...
                    <p class="ojt-text-sm ojt-text-gray-600 ojt-leading-none ojt-mt-1">
                      You are currently using <b>Version <?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->version;?>
</b>, the most recent version is <b
              ...
              <div x-data="dashboard()" id="dashboard"
                ...
                <div class="ojt-border-t ojt-border-gray-200">
                  <div x-show="tab == 'plugin-installed'" class="ojt-bg-white ojt-rounded-lg" role="tabpanel">
                    <?php echo $_smarty_tpl->tpl_vars['pluginInstalledHtml']->value;?>
                  ...
                  <div x-show="tab == 'plugin-gallery'" class="ojt-p-4 ojt-bg-white ojt-rounded-lg plugin-gallery"
                    ...
                    <?php echo $_smarty_tpl->tpl_vars['pluginGalleryHtml']->value;?>
 ...
 <a href="https://openjournaltheme.com" target="_blank"
            ...
            <p class="version ojt-text-right">
              Current Version : <b> <?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->version;?>
 </b>
            </p>
          </div>
        </div>
...
<footer>
  <?php echo '<script'; ?>
>
    var api = '<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->api;?>
';
    var baseUrl = '<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->baseUrl;?>
';
    var thisPage = '<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->pageName;?>
';
    var placeholderImg = '<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->placeholderImg;?>
';
    var ojtPluginVersion = '<?php echo $_smarty_tpl->tpl_vars['ojtPlugin']->value->version;?>
';
  <?php echo '</script'; ?>
>

  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ojtPlugin']->value->javascript, 'js');
